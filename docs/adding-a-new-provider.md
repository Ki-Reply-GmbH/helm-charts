...
cat <<EOF | kubectl apply --server="https://kcp.api.portal.dev.local:8443/clusters/root:orgs:test" -f -
apiVersion: apis.kcp.io/v1alpha1
kind: APIBinding
metadata:
...
cat <<EOF | kubectl apply --server="https://kcp.api.portal.dev.local:8443/clusters/root:orgs:test:test-acc" -f -
apiVersion: apis.kcp.io/v1alpha1
kind: APIBinding
metadata:
